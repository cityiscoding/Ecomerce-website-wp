...
<li class="account-item has-icon
  ...
  <a href="<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>"
    class="xoo-el-login-tgr <?php if($icon_style && $icon_style !== 'image') echo get_flatsome_icon_class($icon_style, 'small'); ?>"
    <?php if( get_theme_mod('') == 'lightbox' && !is_checkout() && !is_account_page() ) echo '"'; ?>>
    <?php if(get_theme_mod('header_account_title', 1)) { ?>
    <span>
