...
<span
  class="xoo-el-form-txt"><?php _e( 'This key is invalid or has already been used. Please reset your password again if needed.', 'easy-login-woocommerce' ); ?></span>

<?php else: ?>

<span class="xoo-el-form-txt"><?php _e( 'Bạn hãy điển mật khẩu mới', 'easy-login-woocommerce' ); ?></span>
...
<button type="submit"
  class="button btn xoo-el-action-btn xoo-el-resetpw-btn"><?php _e( 'Thay đổi mật khẩu', 'easy-login-woocommerce' ); ?></button>
