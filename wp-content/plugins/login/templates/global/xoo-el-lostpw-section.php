...
<span
  class="xoo-el-form-txt"><?php _e('Bạn quên mật khẩu? Hãy điền Tên đăng nhập hoặc Email. Bạn sẽ nhận được một email đổi mật khẩu.','easy-login-woocommerce'); ?></span>
...
<button type="submit"
  class="button btn xoo-el-action-btn xoo-el-lostpw-btn"><?php esc_html_e( xoo_el_helper()->get_general_option( 'txt-btn-respw' ) ) ?></button>