...
<div class="xoo-aff-group xoo-el-login-btm-fields">
  <label class="xoo-el-form-label">
    ...
    <span><?php _e('Tự động đăng nhập', 'easy-login-woocommerce' ); ?></span>
  </label>
  <a class="xoo-el-lostpw-tgr" rel="nofollow" href="#"><?php _e('Quên mật khẩu?','easy-login-woocommerce'); ?></a>
</div>
...
<button type="submit" class="button btn xoo-el-action-btn xoo-el-login-btn"
  <?php if( !xoo_el_is_limit_login_ok() ) echo "disabled"; ?>><?php esc_html_e( xoo_el_helper()->get_general_option( 'txt-btn-login' ) ) ?></button>
