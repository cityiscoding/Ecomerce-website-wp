                                    ...
                                    <div class="service-fee">
                                        ...
                                        <div class="service-fee-info">
                                            ...
                                            if (!Ship_Depot_Helper::check_null_or_empty($serv->TimeExpected)) {
                                                ...
                                                ?>
                                                    <p class="text-description service-fee-description"><?php echo esc_html__('Thời gian di chuyển từ lúc lấy hàng:', 'ship-depot-translate') . ' ' . esc_html($serv->TimeExpected) ?></p>
                                                <?php
                                                } else {
                                                ?>
                                                    <p class="text-description service-fee-description"><?php echo esc_html__('T.gian nhận hàng ước tính:', 'ship-depot-translate') . ' ' . esc_html($serv->TimeExpected) ?></p>
                                                <?php
                                                }
                                            }
