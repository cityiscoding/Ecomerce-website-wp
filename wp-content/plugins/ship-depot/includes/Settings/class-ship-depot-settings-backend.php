    ...
    class Ship_Depot_Settings extends WC_Settings_Page
    {
        ...
        public function save_couriers()
        {
            ...
            if (!isset($_POST['sd_couriers_nonce']) || !wp_verify_nonce($_POST['sd_couriers_nonce'], 'sd_couriers')) {
                ...
                // process form data
                Ship_Depot_Logger::wrlog('[save_couriers] data: ' . print_r($_POST, true));
                ...
                foreach ($_POST['couriers_id'] as $id) {
                    ...
                    if (isset($_POST[$courier_id])) {
                        Ship_Depot_Logger::wrlog('[save_couriers] courier data: ' . print_r(sanitize_text_field($_POST[$courier_id]), true));
                        //Get old data
                ...
                Ship_Depot_Logger::wrlog('[save_couriers] List couriers aft: ' . print_r($list_couriers, true));
                ...
                $rs = Ship_Depot_Helper::http_post($url, $request_param, array('ShopAPIKey' => $shop_api_key));
